 ...
 */
public class TestPassphrases {
    Passphrases passphrases = new Passphrases();

    @Test
    public void testInput1() {
        assertEquals(1, passphrases.countValidPassphrases("aa bb cc dd ee"));
    }

    @Test
    public void testInput2() {
        assertEquals(0, passphrases.countValidPassphrases("aa bb cc dd aa"));
    }

    @Test
    public void testInput3() {
        assertEquals(1, passphrases.countValidPassphrases("aa bb cc dd aaa"));
    }

    @Test
    public void testInput4() {
        assertEquals(466, passphrases.countValidPassphrases("pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk\n" +
    ...
    public void testInput5() {
        assertEquals(0, passphrases.countValidPassphrasesNoAnagrams("abcde xyz ecdab"));
    }

    @Test
    public void testInput6() {
        assertEquals(1, passphrases.countValidPassphrasesNoAnagrams("a ab abc abd abf abj"));
    }

    @Test
    public void testInput7() {
        assertEquals(1, passphrases.countValidPassphrasesNoAnagrams("iiii oiii ooii oooi oooo"));
    }

    @Test
    public void testInput8() {
        assertEquals(0, passphrases.countValidPassphrasesNoAnagrams("oiii ioii iioi iiio"));
    }

    @Test
    public void testInput9() {
        assertEquals(251, passphrases.countValidPassphrasesNoAnagrams("pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk\n" +
                "vxjnf fzqitnj uyfck blnl impo kxoow nngd worcm bdesehw\n" +
                "caibh nfuk kfnu llfdbz uxjty yxjut jcea\n" +
                "qiho qif eupwww avyglnj nxzotsu hio lws\n" +
                "xjty usocjsh pivk qnknunc yjcgh bwya djw zpyr\n" +
